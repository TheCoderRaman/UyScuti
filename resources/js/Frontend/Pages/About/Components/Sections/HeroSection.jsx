                    ...
                    <div className="w-full px-4">
                        <div className="wow fadeInUp mx-auto max-w-[800px] text-center" data-wow-delay=".2s">
                            <h1 className="mb-5 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                                {t('frontend.Free and Open-Source Search Engine')}
                            </h1>
                            <p className="mb-12 text-base font-medium !leading-relaxed text-body-color dark:text-white dark:opacity-90 sm:text-lg md:text-xl">
                            {t('frontend.UyScuti is free Search Engine which uses laravel as backend and react as frontend with Tailwind as CSS framework.')}
                            </p>
                            <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                                <a
                                    href="https://github.com/animaxdev/UyScuti"
                                    className="rounded-md bg-black/20 py-4 px-8 text-base font-semibold text-black duration-300 ease-in-out hover:bg-black/30 dark:bg-white/20 dark:text-white dark:hover:bg-white/30"
                                >
                                    {t('frontend.Star on GitHub')}
                                </a>
                            </div>
                        </div>
                    </div>
