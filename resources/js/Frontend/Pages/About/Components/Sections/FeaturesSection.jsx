    ...
    return (
        <section id="features" className="bg-primary/[.03] py-16 md:py-20 lg:py-28">
            <div className="container">
                ...
                <div className="wow fadeInUp w-full mx-auto text-center" data-wow-delay=".1s" style={{ maxWidth: '665px', marginBottom: '100px' }}>
                    <h2 className="mb-4 text-3xl font-bold !leading-tight text-black dark:text-white sm:text-4xl md:text-[45px]">
                        {t('frontend.Your personal data')}
                        <br />
                        {t('frontend.Is nobody\'s business.')}
                    </h2>
                    <p className="text-base !leading-relaxed text-body-color md:text-lg text-black dark:text-white">
                        {t('frontend.Our mission is to show the world that protecting privacy is simple. For over a decade, we\'ve created new technology and worked with policymakers to make online privacy simple and accessible for all.')}
                    </p>
                </div>
                ...
                <div className="wow fadeInUp w-full mx-auto text-center" data-wow-delay=".1s" style={{ maxWidth: '570px', marginBottom: '100px' }}>
                    <h2 className="mb-4 text-3xl font-bold !leading-tight text-black dark:text-white sm:text-4xl md:text-[45px]">
                        {t('frontend.Our Goals')}
                    </h2>
                    <p className="text-base text-black dark:text-white !leading-relaxed text-body-color md:text-lg">
                        {t('frontend.For everyone who\'s had enough of online tracking, UyScuti lets you take back your online privacy now.')}
                    </p>
                </div>
                    ...
                    <div className="w-full">
                        <div className="wow fadeInUp" data-wow-delay=".15s">
                            <div className="mb-10 flex h-[70px] w-[70px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-primary">
                                <svg width="40" height="41" viewBox="0 0 40 41" className="fill-black dark:fill-white">
                                    <path
                                        opacity="0.5"
                            ...
                            <h3 className="mb-5 text-xl font-bold text-black dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                                #{t('frontend.Safety')}{t('frontend.First')}
                            </h3>
                            <p className="pr-[10px] text-black dark:text-white text-base font-medium leading-relaxed text-body-color">
                                {t('frontend.We protect you no matter where you go on the Internet.')}
                            </p>
                        </div>
                    </div>
                    <div className="w-full">
                        <div className="wow fadeInUp" data-wow-delay=".15s">
                            <div className="mb-10 flex h-[70px] w-[70px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-primary">
                                <svg width="40" height="40" viewBox="0 0 40 40" className="fill-black dark:fill-white">
                                    <path
                                        opacity="0.5"
                            ...
                            <h3 className="mb-5 text-xl font-bold text-black dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                                #{t('frontend.Better')}{t('frontend.Exprience')}
                            </h3>
                            <p className="pr-[10px] text-black dark:text-white text-base font-medium leading-relaxed text-body-color">
                                {t('frontend.UyScuti began as an idea for a better search engine experience.')}
                            </p>
                        </div>
                    </div>
                    <div className="w-full">
                        <div className="wow fadeInUp" data-wow-delay=".15s">
                            ...
                            <h3 className="mb-5 text-xl font-bold text-black dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                                #{t('frontend.Anonymous')}
                            </h3>
                            <p className="pr-[10px] text-black dark:text-white text-base font-medium leading-relaxed text-body-color">
                                {t('frontend.We maked bold moves to not track your search history. Tracking is creepy.')}
                            </p>
                        </div>
                    </div>
                    <div className="w-full">
                        <div className="wow fadeInUp" data-wow-delay=".15s">
                            <div className="mb-10 flex h-[70px] w-[70px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-primary">
                                <svg width="40" height="42" viewBox="0 0 40 42" className="fill-black dark:fill-white">
                                    <path
                                        opacity="0.5"
                            ...
                            <h3 className="mb-5 text-xl font-bold text-black dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                                #{t('frontend.The')}{t('frontend.Billboard')}
                            </h3>
                            <p className="pr-[10px] text-black dark:text-white text-base font-medium leading-relaxed text-body-color">
                                {t('frontend.We told the world “Search engines tracks you. We don\'t.” with a billboard in their backyard. Hello, World!')}
                            </p>
                        </div>
                    </div>
                    <div className="w-full">
                        <div className="wow fadeInUp" data-wow-delay=".15s">
                            ...
                            <h3 className="mb-5 text-xl font-bold text-black dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                                #{t('frontend.Privacy')}{t('frontend.Beyond')}{t('frontend.Search')}
                            </h3>
                            <p className="pr-[10px] text-black dark:text-white text-base font-medium leading-relaxed text-body-color">
                                {t('frontend.We extendeds our privacy protection beyond the search box with availability on all major platforms.')}
                            </p>
                        </div>
                    </div>
                    <div className="w-full">
                        <div className="wow fadeInUp" data-wow-delay=".15s">
                            <div className="mb-10 flex h-[70px] w-[70px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-primary">
                                <svg width="40" height="45" viewBox="0 0 40 45" className="fill-black dark:fill-white">
                                    <path
                                        opacity="0.5"
                            ...
                            <h3 className="mb-5 text-xl font-bold text-black dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                                #{t('frontend.Free')}{t('frontend.And')}{t('frontend.Open')}{t('frontend.Source')}
                            </h3>
                            <p className="pr-[10px] text-black dark:text-white text-base font-medium leading-relaxed text-body-color">
                                {t('frontend.We belive the power of Open Source is the power of the people.')}
                            </p>
                        </div>
                    </div>
                </div>
