        ...
        <>
            <div className="flex flex-grow">
                <label className="relative">
                    ...
                    {!isEmpty(searches.searchTerm) && (
                        <button onClick={handleClear} className="absolute top-[30%] right-[5%]">
            ...
            <div className="pt-5">
                <button
                    ...
                    className="bg-[#f8f9fa] dark:bg-[#3c4043] text-[#4d5156] dark:text-[#bdc1c6] p-2 rounded-md hover:border-white border-transparent border-2"
                >
